...
void parse_file ( char * filename, 
  ...
  while ( fgets(line, 255, f) != NULL ) {
    ...
    if (strncmp(line, "push", strlen(line)) == 0){
      ...
      add_edge(tmpedge, x, y, z, x1, y1, z1);
      matrix_mult(st->data[st->top],tmpedge);
      draw_lines(tmpedge,s,g);
      free_matrix(tmpedge);
      //tmpedge->lastcol = 0;
      ...
      add_curve(tmpedge, x1, y1, x2, y2, x3, y3, x4, y4, 0.01, BEZIER_MODE );
      matrix_mult(st->data[st->top],tmpedge);
      draw_lines(tmpedge,s,g);
      free_matrix(tmpedge);
      //tmpedge->lastcol = 0;
      ...
      sscanf(line, "%lf %lf %lf %lf %lf %lf %lf %lf",
	     &x1, &y1, &x2, &y2, &x3, &y3, &x4, &y4);
      add_curve(tmpedge, x1, y1, x2, y2, x3, y3, x4, y4, 0.01, HERMITE_MODE );
      matrix_mult(st->data[st->top],tmpedge);
      draw_lines(tmpedge,s,g);
      free_matrix(tmpedge);
      //tmpedge->lastcol = 0;
      ...
      fgets(line, 255, f);
      sscanf(line, "%lf %lf %lf %lf %lf %lf", &x, &y, &z, &x1, &y1, &z1);
      add_box(tmppoly, x, y, z, x1, y1, z1);
      matrix_mult(st->data[st->top],tmppoly);
      draw_polygons(tmppoly,s,g);
      free_matrix(tmppoly);
      //tmppoly->lastcol = 0;
      // printf( "%lf %lf %lf %lf %lf %lf\n", x, y, z, x1, y1, z1);
    }
